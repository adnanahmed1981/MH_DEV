...
<h2 style="font:bold 18px/18px Arial, Helvetica, sans-serif; color:#b72f45; padding:0 0 19px; margin:0">As-salamu alaykum <?php echo $memberOld->FirstName; ?>,</h2>
<br>

<br>
<p style="font:normal 12px/18px Arial, Helvetica, sans-serif; color:#606060; padding:0 0 15px; margin:0">
We are happy to introduce the new and improved MuslimHarmony.com. 
<br><br>
...
And so much more...
<br><br>
To thank you as one of our previous member of Muslim Harmony we would like to provide you with an Exclusive Gift Membership. 
</p>
<br>
...
<p style="font:normal 12px/18px Arial, Helvetica, sans-serif; color:#606060; padding:0 0 15px; margin:0">Expires: <?php echo $coupon->expiry_date;?>

<p style="font:normal 12px/18px Arial, Helvetica, sans-serif; color:#606060; padding:0 0 15px; margin:0">
<a class="linkA" target="_blank" href="<?php echo Yii::app()->request->hostInfo.Yii::app()->request->baseUrl; ?>"/index.php/site/login">
MuslimHarmony.com
</a>
</p>
